Config = {
    ...
    ranchSetup = {
        ...
        herdingCooldown = 60000, -- 1 minute (Time that must pass before you can herd again)
        feedingCooldown = 60000, -- 1 minute (Time that must pass before you can feed again)
        ...
        choreSetup = {
            ...
            choreCooldown = 60000, -- 1 minute (Time that must pass before you can complete another chore after doing one)
            choreMinigames = true,
            shovelHayCondInc = 10,
    ...
    animalSetup = {
        ...
        cows = {
            ...
            milkingCooldown = 60000, -- 1 minute (Time that must pass before you can milk cows again)
        ...
        sheeps = {
            ...
            shearingCooldown = 60000, -- 1 minute (Time that must pass before you can shear sheep again)
            butcherItems = { --items you will get when you butcher this animal
                {
                    name = 'Ingredient_Beef_Meat', --item db name
                    count = 4, --amount you will get
        ...
        chickens = {
            ...
            harvestingCooldown = 60000, -- 1 minute (Time that must pass before you can harvest eggs again)
            butcherItems = { --items you will get when you butcher this animal
                {
                    name = 'Ingredient_Beef_Meat', --item db name
                    count = 4, --amount you will get
